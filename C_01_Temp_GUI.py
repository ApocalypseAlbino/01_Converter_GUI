...
class Converter:
    ...
    def __init__(self):
        ...
        self.to_celcius_button.grid(row=0, column=0, pady=5, padx=5)
        ...
        self.to_fahrenheit_button = Button(self.button_frame,
                                        ...
                                        fg="#ffffff",
                                        font=("Arial", "12", "bold"), width=12)
        self.to_fahrenheit_button.grid(row=0, column=1, pady=5, padx=5)
        ...
        self.help_button = Button(self.button_frame,
                                        ...
                                        fg="#ffffff",
                                        font=("Arial", "12", "bold"), width=12)
        self.help_button.grid(row=1, column=0, pady=5, padx=5)
        ...
        self.history_button = Button(self.button_frame,
                                        ...
                                        fg="#ffffff",
                                        font=("Arial", "12", "bold"), width=12)
        self.history_button.grid(row=1, column=1, pady=5, padx=5)
